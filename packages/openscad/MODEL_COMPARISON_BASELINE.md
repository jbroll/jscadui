...
Verified 2026-04-04 — commit `19cf725` on `hierarchical-params` (output optimization: resolveUndef, applyPositionalArgs, resolveParams, withScope fast path).
...
| dotSCAD    |   212 |       0 |            29 |         0 |    183 |     67 |     61 |     55 | 36.6%     |
